...
def _postprocess_call(call, user_text):
    ...
    if name == "send_message":
        ...
        # e.g., "I'll be late." instead of "I'll be late"
...
def generate_hybrid(messages, tools):
    ...
    if is_multi:
        ...
        if len(sub_actions) > 1:
            ...
            # Cloud-assist failed/skipped sub-actions — one cloud call per sub-action
            # (combining them causes Gemini to treat them as sequential and only return the first)
